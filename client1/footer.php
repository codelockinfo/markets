    ...
    <div class="container-fluid copyright bg-dark py-4">
        <div class="container">
            <div class="text-center mb-3 mb-md-0">
                <span class="text-light"><a href="https://codelocksolutions.in/"><i class="fas fa-copyright text-light me-2"></i><a href="#"><i class="fas fa-copyright text-light me-2"></i>Codelock solution</a>, All right reserved.</a></span>
            </div>
        </div>
    </div>
    <!-- Copyright End -->
