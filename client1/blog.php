        ...
        <div class="container">
            ...
            <div class="row gx-4 justify-content-center">
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                           <a href="<?php echo CLS_SITE_URL ?>blog_details1.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog1.png" class="img-fluid w-100" alt="blog1"></a>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.3s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <a href="<?php echo CLS_SITE_URL ?>blog_details2.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog2.png" class="img-fluid w-100" alt="blog2"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.5s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                           <a href="<?php echo CLS_SITE_URL ?>blog_details3.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog3.png" class="img-fluid w-100" alt="blog3"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <a href="<?php echo CLS_SITE_URL ?>blog_details4.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog4.png" class="img-fluid w-100" alt="blog4"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.3s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <a href="<?php echo CLS_SITE_URL ?>blog_details5.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog5.jpg" class="img-fluid w-100" alt="blog5"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.5s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <a href="<?php echo CLS_SITE_URL ?>blog_details6.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog6.png" class="img-fluid w-100" alt="blog6"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.1s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <a href="<?php echo CLS_SITE_URL ?>blog_details7.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog7.png" class="img-fluid w-100" alt="blog7"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.3s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                            <a href="<?php echo CLS_SITE_URL ?>blog_details8.php"><img src="<?php echo CLS_SITE_URL; ?>img/blog8.png" class="img-fluid w-100" alt="blog8"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
                ...
                <div class="col-md-6 col-lg-4 wow bounceInUp" data-wow-delay="0.5s">
                    <div class="blog-item">
                        <div class="overflow-hidden rounded">
                           <a href="<?php echo CLS_SITE_URL ?>blog_details9.php"> <img src="<?php echo CLS_SITE_URL; ?>img/blog9.png" class="img-fluid w-100" alt="blog9"></a>
                        </div>
                        <div class="blog-content mx-4 d-flex rounded bg-light">
                            <div class="text-dark bg-primary rounded-start">
                                <div class="h-100 p-3 d-flex flex-column justify-content-center text-center">
