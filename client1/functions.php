    ...
    function bannershow()
    {
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                $noimagePath = "../admin1/assets/img/banner_img/noimage.png";
    ...
    function famousmarketshow()
    {
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                $noimagePath = "../admin1/assets/img/famous_market/noimage.png";
                $decodedPath = htmlspecialchars_decode(
                    (!empty($image) && file_exists($imagePath)) ? $imagePath : $noimagePath
                );
    ...
    function offershow()
    {
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                $noimagePath = "../admin1/assets/img/offers/noimage.png";
                $decodedPath = htmlspecialchars_decode(
                    (!empty($image) && file_exists($imagePath)) ? $imagePath : $noimagePath
                );
    ...
    function reviewshow()
    {
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result)) {
                ...
                $noimagePath = "../admin1/assets/img/marketreview/noimage.png";
                $decodedPath = htmlspecialchars_decode(
                    (!empty($image) && file_exists($imagePath)) ? $imagePath : $noimagePath
                );
                $rating = $row['review'];
        ...
        if ($categoryresult) {
            ...
            while ($categoryrow = mysqli_fetch_array($categoryresult)) {
                ...
                if (array_key_exists($categoryrow['categories'], $categories)) {
                    $browsecategorytab .= $categories[$categoryrow['categories']] . ',';
                    $browsecategorytabmobile .= $categories[$categoryrow['categories']] . ',';
