...
<body>
    ...
    <!-- BANNER SECTION  -->
    <div class="contact-s-banner">
        <div class="c-banner-img position-relative ">
            <img src="img/seller-contact.jpg" class="contact-shop-img w-100" alt="">
            <div class="seller-logo-img position-relative  overflow-hidden">
                <img src="img/sellerlogo.jpg" class="w-100 h-100">
            </div>
        </div>
    </div>
    <div class="contact-seller-form py-60 pb-60 position-relative">
    <div class="img-customec position-absolute">
            <img src="img/img3.png" class="w-25">
        </div>
        <div class="custom-container">
            <div class="">
                <h2 class="text-center contactus-heading heading-font text-main fw-bold f-50">
                    Contact us for any queries!
                </h2>
                <form action="" class="my-5 contact-form row">
                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                        <input class=" py-3  w-100 px-2 light-color" type="text" placeholder="Your Name" />
                    </div>
                    <div class="col-12 col-md-6 my-3  my-md-0">
                        <input class=" py-3 w-100 px-2 light-color" type="email" placeholder="Your Email" />
                    </div>
                    <div class="col-12 my-3 my-md-4">
                        <textarea class=" py-3 px-2 light-color w-100 " name="" id="" rows="10"
                            placeholder="Your Message"></textarea>
                    </div>
                    <a href="#"
                        class="main-color w-auto py-3 px-5 text-decoration-none text-white border-r mx-auto">Submit</a>
                </form>
            </div>
     <!-- SELLER CONTACT PAGE DETAILS  -->
            <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
                <div class="address-box semi-light-color p-2 border-r shadow position-relative">
                    <div class="contact-icon main-color">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="36" height="36" x="0" y="0"
                    ...
                    <div class="a-content-box text-center px-5">
                        <h6 class="mt-5 f-22">Address</h6>
                        <p class="mt-3 f-18">
                            2020, Silver business point, near VIP circle, Digital
                            valley, Uttran, Surat 395006
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
                <div class="address-box semi-light-color p-2 border-r shadow position-relative">
                    ...
                    <div class="a-content-box text-center px-5 pb-4">
                        <h6 class="mt-5 pt-3 f-22">Mail Us</h6>
                        <a class="mt-3 f-18 text-decoration-none text-dark">codelockinfo@gmail.com</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
