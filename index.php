                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body border-0">
                            <div class="position-relative">
                                <img src="img/logo2.png" alt="Logo" class="rounded-circle border custom-image">
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="svg-container d-flex col-10">
                                    <a href="#"
                                        class="text-decoration-none custom_button text-center px-4 main-color border-r py-2 fw-bold border-0 z-index"><svg
                                ...
                                <div class="svg-container d-flex col-2 justify-content-end">
                                    <a href="#"
                                        class="text-decoration-none custom_button text-center main-color border-r px-2 py-2 fw-bold border-0 z-index" title="Contact seller">
