...
<body>
    ...
    <!-- Banner -->
    <section class="light-color banner-section">
        <div class="swiper banner">
            <div class="swiper-wrapper">
                <div class="swiper-slide border-r">
                    <a href="#"><img src="img/img18.webp"></a>
                </div>
                <div class="swiper-slide border-r">
                    <a href=""><img src="img/img19.webp"></a>
                </div>
                <div class="swiper-slide border-r">
    ...
    <section class="semi-light-color position-relative py-60 pb-60">
        ...
        <div class="custom-container">
            <div class="d-flex justify-content-between align-items-center">
                <h1 class="fw-bold heading-font f-30">Famous Markets in Surat</h1>
                <a href="#"
                    class="text-decoration-none z-index main-color border-r custom_button px-4 py-2 fw-bold border-0 ">View
                    all</a>
            </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body border-0">
                            ...
                            <h5 class="card-title mt-2 f-26 fw-bold ">Dream Shop</h5>
                            <p class="card-text f-16   "><span class="text-danger fw-bold">3</span>
                                Products</p>
                            <div class="d-flex justify-content-between ">
                                <div class="svg-container d-flex custom_button2 justify-content-center align-items-center text-center px-4 main-color border-r py-2">
                                    <svg
                                        ...
                                        <g>
                                            <path
                                                d="M347.7 263.75h-66.5c-18.2 0-33 14.8-33 33v51c0 18.2 14.8 33 33 33h66.5c18.2 0 33-14.8 33-33v-51c0-18.2-14.8-33-33-33zm9 84c0 5-4.1 9-9 9h-66.5c-5 0-9-4.1-9-9v-51c0-5 4.1-9 9-9h66.5c5 0 9 4.1 9 9v51z"
                            ...
                            <div class="row justify-content-between align-items-center custom_tranding ">
                                <div class="col-sm-5">
                                    <div class="text-center">
                                        ...
                                        <div class="svg-container d-flex custom_button2 justify-content-center align-items-center text-center px-1 w-75 mx-auto main-color border-r py-2">
                                    <svg
                                        class="me-2" xmlns=" http://www.w3.org/2000/svg " version="1.1"
                                        xmlns:xlink=" http://www.w3.org/1999/xlink " width="20" height="20" x="0" y="0"
                                        viewBox="0 0 489.4 489.4" style="enable-background:new 0 0 512 512"
    ...
    <section class="light-color position-relative overflow-hidden py-60">
        <div class="d-flex w-100">
            <div class="img-custome1  position-absolute">
                <img src="img/img3.png" class="w-25">
            </div>
            <div class="img-custome2 position-absolute">
                <img src="img/img14.png" class="w-25">
            </div>
        </div>
        <div class="custom-container">
            <div>
            ...
            <div class="row g-3">
                <div class="col-lg-6 col-md-12">
                    <a href="#"><img src="img/img10.jpg" class="img-fluid border-r h-100 w-100"></a>
                </div>
                <div class="col-lg-6 col-md-12">
                    <a href="#"><img src="img/img9.jpg" class="img-fluid border-r mb-3 w-100"></a>
                    <div class="row g-3">
                        <div class="col-lg-6 col-md-12">
                            <a href="#"><img src="img/img8.jpg" class="img-fluid border-r w-100"></a>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <a href="#"><img src="img/img4.jpg" class="img-fluid border-r w-100 h-100"
                                    alt="Shop Now Image"></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- FAQs -->
    <section class="light-color py-60 overflow-hidden position-relative faq-section">
        <div class="img-custome4 position-absolute">
            <img src="img/img22.png" class="w-50">
        </div>
        <div class="custom-container">
            <div>
    ...
    <div class="icon-contact">
        <a href="#"> <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" x="0" y="0" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                <g>
                    <path d="M366 396c-5.52 0-10 4.48-10 10s4.48 10 10 10 10-4.48 10-10-4.48-10-10-10z" fill="#0E343D" opacity="1" data-original="#0E343D" class=""></path>
                    <path d="m390.622 363.663-47.53-15.84-17.063-34.127c15.372-15.646 26.045-36.348 29.644-57.941L357.801 243H376c16.542 0 30-13.458 30-30v-63C406 67.29 338.71 0 256 0c-82.922 0-150 67.097-150 150v63c0 13.036 8.361 24.152 20 28.28V253c0 16.542 13.458 30 30 30h8.782a108.487 108.487 0 0 0 16.774 25.974 103.947 103.947 0 0 0 4.406 4.741l-17.054 34.108-47.531 15.841C66.112 382.092 26 440.271 26 502c0 5.523 4.477 10 10 10h440c5.522 0 10-4.477 10-10 0-61.729-40.111-119.908-95.378-138.337zM386 213c0 5.514-4.486 10-10 10h-15.262c2.542-19.69 4.236-40.643 4.917-61.28.02-.582.036-1.148.054-1.72H386v53zm-250 10c-5.514 0-10-4.486-10-10v-53h20.298c.033 1.043.068 2.091.107 3.146l.004.107v.009c.7 20.072 2.372 40.481 4.856 59.737H136V223zm20 40c-5.514 0-10-4.486-10-10v-10h8.198l2.128 12.759a105.57 105.57 0 0 0 1.482 7.241H156zm-9.983-123H126.38C131.445 72.979 187.377 20 256 20c68.318 0 124.496 52.972 129.619 120h-19.635c-.72-55.227-45.693-100-101.033-100h-17.9c-55.339 0-100.315 44.773-101.034 100zM247.05 60h17.9c44.809 0 81.076 36.651 81.05 81.41 0 3.147-.025 5.887-.078 8.38l-.001.098-12.508-1.787c-33.98-4.852-66.064-20.894-90.342-45.172A10.003 10.003 0 0 0 236 100c-26.856 0-52.564 12.236-69.558 32.908C170.63 92.189 205.053 60 247.05 60zm-68.51 203c-5.006-16.653-10.734-65.653-12-97.053l13.459-17.946c12.361-16.476 31.592-26.713 52.049-27.888 26.917 25.616 61.739 42.532 98.537 47.786l14.722 2.104c-.984 20.885-2.995 41.843-5.876 61.118l-.003.02c-.916 6.197-1.638 10.185-3.482 21.324-5.296 31.765-28.998 60.49-60.287 68.313a81.338 81.338 0 0 1-39.313 0c-19.537-4.884-37.451-18.402-49.012-37.778h20.386c4.128 11.639 15.243 20 28.28 20h20c16.575 0 30-13.424 30-30 0-16.542-13.458-30-30-30h-20c-13.327 0-24.278 8.608-28.297 20H178.54zm56.619 78.016A101.171 101.171 0 0 0 256 343.2c5.471 0 10.943-.458 16.353-1.346l-17.67 18.687-19.524-19.525zm5.776 34.063-31.718 33.542a381.013 381.013 0 0 1-22.389-51.917l11.911-23.822 42.196 42.197zm70.631-45.585 13.604 27.209a380.908 380.908 0 0 1-22.392 51.933l-
365 0 0 1-4.357-4.361c0-2.398-1.176-4.508-2.965-5.835 1.817.766 3.802 1.169 5.854 1.33.474.097.965.148 1.468.148 2.403 0 4.361 1.953 4.361 4.357s-1.958 4.361-4.361 4.361zm1.469-23.132a7.334 7.334 0 0 0-1.469-.148c-2.403 0-4.357-1.958-4.357-4.361s1.953-4.357 4.357-4.357 4.361 1.953 4.361 4.357c0 2.403 1.18 4.517 2.976 5.843-1.821-.77-3.811-1.173-5.868-1.334zM207.974 34.679h-25.722c-4.02 0-7.281 3.261-7.281 7.281s3.261 7.281 7.281 7.281h5.58v39.28c0 4.02 3.261 7.281 7.281 7.281s7.281-3.261 7.281-7.281v-39.28h5.58c4.02 0 7.281-3.261 7.281-7.281s-3.261-7.281-7.281-7.281zM244.116 34.679c-16.853 0-30.562 13.71-30.562 30.562s13.71 30.562 30.562 30.562 30.562-13.71 30.562-30.562-13.71-30.562-30.562-30.562zm0 46.562c-8.822 0-15.999-7.177-15.999-15.999s7.177-15.999 15.999-15.999 15.999 7.177 15.999 15.999-7.177 15.999-15.999 15.999zM328.189 53.599c0-10.434-8.49-18.919-18.924-18.919h-16.146a7.283 7.283 0 0 0-7.281 7.281v46.561c0 4.02 3.261 7.281 7.281 7.281s7.281-3.261 7.281-7.281V72.523h4.364l9.63 19.256a7.283 7.283 0 0 0 13.027-6.513l-7.904-15.805c5.204-3.376 8.672-9.211 8.672-15.862zM300.4 49.242h8.865c2.403 0 4.361 1.953 4.361 4.357s-1.958 4.361-4.361 4.361H300.4zM367.113 49.242c4.02 0 7.281-3.261 7.281-7.281s-3.261-7.281-7.281-7.281h-20.489a7.283 7.283 0 0 0-7.281 7.281v46.561a7.283 7.283 0 0 0 7.281 7.281h20.489c4.02 0 7.281-3.261 7.281-7.281s-3.261-7.281-7.281-7.281h-13.207v-8.718h13.207c4.02 0 7.281-3.261 7.281-7.281s-3.261-7.281-7.281-7.281h-13.207v-8.718h13.207z" fill="#0E343D" opacity="1" data-original="#0E343D" class=""></path>
                </g>
            </svg></a>
    </div>
    <div class="icon-topbottom">
        <a href="#"> <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" x="0" y="0" viewBox="0 0 32 32" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                <g>
                    <path d="M5.71 17.58 16 7.29l10.29 10.29a1 1 0 0 0 1.42-1.41l-11-11a1 1 0 0 0-1.42 0l-11 11a1 1 0 0 0 0 1.41 1 1 0 0 0 1.42 0z" fill="#0E343D" opacity="1" data-original="#000000" class=""></path>
                    <path d="M4.29 26.83a1 1 0 0 0 1.42 0L16 16.54l10.29 10.29a1 1 0 0 0 1.42-1.41l-11-11a1 1 0 0 0-1.42 0l-11 11a1 1 0 0 0 0 1.41z" fill="#0E343D" opacity="1" data-original="#0E343D" class=""></path>
                </g>
            </svg></a>
    </div>
</body>
