        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    ...
                    <div class="blog-head">
                            <h4 class="fs-3 text-capitalize fw-bold text-primary">anarkali dreams: 4 tips to find your perfect kurti in  gujrat</h4>
                        </div>
                        <div class="blog_img">
                            <img src="<?php echo CLS_SITE_URL; ?>img/blog_details3.webp" class="img-fluid w-100 rounded" alt="blog_details3">
                        </div>
