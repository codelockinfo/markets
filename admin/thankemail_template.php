...
<body>
    <div class="main-sec" style="max-width: 1140px;margin: auto;background-color: #ffff;border-radius: 30px;">
        <div class="mail-img"
            ...
            <img src="https://codelocksolutions.in/markets/admin/assets/img/thankyou.jpg" alt="Thank you"
                style="width: 85%;margin: 0 auto;display: flex;">
            <img src="https://codelocksolutions.in/markets/admin/assets/img/welcome.jpg" alt="Welcome"
                style="width: 85%;margin: 0 auto;display: flex;">
        </div>
    </div>
</body>
