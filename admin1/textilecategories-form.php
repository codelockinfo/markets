    ...
    <nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
      <div class="container-fluid py-1">
        <nav aria-label="breadcrumb">
          <h6 class="text-white font-weight-bolder ms-2">Brouse By Textile Categories</h6>
        </nav>
        ...
        <div class="col-xl-6 col-lg-9 col-md-6 mx-auto main-sec">
          <div class="card z-index-0 p-5">
            <form role="form" id="b_textileCtgryinsert" enctype="multipart/form-data" method="POST">
              ...
              <div class="mb-3">
                <button type="button" class="btn btn-primary bg-dark btn-sm brouseSave formSave save_loader_show">Save</button>
