...
if ($_SERVER['SERVER_NAME'] == 'textilemarkethub.com') {
  include($http_host . '/connection.php');
}else{
...
<html>
    ...
    <div id="preloader">
        ...
        <link rel="stylesheet" href="<?php echo main_url('admin1/assets/css/custom06.css'); ?>" rel="stylesheet">                                                
        ...
        <script src="<?php echo main_url('admin1/assets/js/ajax08.js'); ?>"></script>
