...
<html>
    ...
    <div id="preloader">
        ...
        <link rel="stylesheet" href="<?php echo main_url('admin1/assets/css/custom05.css'); ?>" rel="stylesheet">                                                
        ...
        <script src="<?php echo main_url('admin1/assets/js/ajax07.js'); ?>"></script>
