...
<html>
    ...
    <div id="preloader">
        ...
        <link rel="stylesheet" href="<?php echo main_url('admin1/assets/css/custom04.css'); ?>" rel="stylesheet">                                                
        ...
        <script src="<?php echo main_url('admin1/assets/js/ajax04.js'); ?>"></script>
