          ...
          <div class="col-auto col-lg-0 col-md-0 my-sm-auto ms-sm-auto me-sm-0 mx-auto">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active " href="<?php echo SITE_ADMIN_URL ?>invoice.php" role="tab" aria-selected="true">
                    ...
                    <span class="ms-1">Add invoice</span>
                  </a>
                </li>
              </ul>
            </div>
      ...
      <div class="card mb-4">
        <div class="d-flex justify-content-between p-3">
          <div class="card-header pb-0 p-3">
            <h6 class="mb-1 mt-1 text-lg">invoicesd</h6>
          </div>
