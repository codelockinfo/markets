        ...
        <div class="col-xl-6 col-md-6 mx-auto main-sec">
          <div class="card z-index-0 p-3">
            ...
            <div class="mb-3 form-check-reverse text-right ">
              ...
              <div class="col-xl-6 col-md-6 mb-xl-0 mb-2 w-100">
                <div class="card card-blog card-plain">
                  <div class="position-relative">
                    <a class="d-block border-radius-xl">
                      <img src="<?php echo main_url('/admin1/assets/img/home-banner.png'); ?>" alt="img-blur-shadow" class="img-fluid shadow border-radius-lg mb-3 mt-3">
                    </a>
                  </div>
