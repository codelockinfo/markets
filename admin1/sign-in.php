      ...
      <div class="page-header min-vh-75">
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="position-absolute top-0 h-100 w-30 top-10 offset-sm-1 d-md-block d-none me-n8">
                <div class="bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n8" style="background-image:url('assets/img/curved-images/curved6.jpg')"></div>
              </div>
            </div> 
          </div>
        </div>
