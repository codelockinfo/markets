                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a href="<?php echo CLS_SITE_URL; ?>"
                                        class="btn btn-sm btn-round mb-0 me-1 bg-gradient-dark">Preview</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card card-plain mt-6">
                            ...
                            <div class="card-body">
                                <form role="form" id="savesignin">
                                    ...
                                    <div class="row ms-0 w-100">
                                        <div class="col-6 w-50">
                                            <a class="btn btn-outline-light img-fluid" href="#">
                                                <svg class="img-fluid facebook" width="100px" height="20px"
                                        ...
                                        <div class="col-6 w-50">
                                            <a class="btn btn-outline-light img-fluid"
                                                href='<?php echo $client->createAuthUrl(); ?>'>
                                                <svg class="img-fluid google" width="100px" height="20px"
                                                    viewBox="0 0 64 64" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="text-center">
                                        <button type="button"
                                            class="btn bg-gradient-info w-100 mt-0 mb-0 signInsave">Sign
                                            in</button>
                                    </div>
                            </div>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                <p class="mb-4 text-sm mx-auto">
                                    ...
                                    <a href="<?php echo SITE_ADMIN_URL ?>sign-up.php"
                    ...
                    <div class="col-md-6">
                        <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                            <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                                style="background-image:url('assets/img/sign-in-up.jpeg')"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="mb-1 mx-auto text-center">
                    ...
                    <a href="<?php echo CLS_SITE_URL ?>product.php" target="_blank"
                        class="text-secondary me-3 mb-sm-0 mb-2">
                        Products
                    </a>
                    <a href="<?php echo CLS_SITE_URL ?>blog.php" target="_blank"
                        class="text-secondary  me-3 mb-sm-0 mb-2">
                        Blog
                    </a>
                </div>
