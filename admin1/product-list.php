          ...
          <div class="col-auto col-lg-0 col-md-0 my-sm-auto ms-sm-auto me-sm-0 mx-auto">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1 active " href="<?php echo SITE_ADMIN_URL ?>product-form.php" role="tab" aria-selected="true">
        ...
        <div class="d-flex justify-content-between p-3">
          ...
          <div class="ms-md-auto pe-md-0 d-flex align-items-center me-2">
            <div class="input-group search-btn search-icon">
              ...
              <input type="text" class="form-control search-btn_1" id="search" placeholder="Type here...">
            </div>
          </div>
