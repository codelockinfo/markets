                ...
                <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
                    <div class="ms-md-auto pe-md-3 d-flex align-items-center">
                        <div class="input-group search-btn">
                            <span class="input-group-text text-body search-btn_2"><i class="fas fa-search"
                    ...
                    <ul class="navbar-nav justify-content-end">
                        <li class="nav-item d-flex align-items-center online-btn">
                            <a class="btn btn-outline-white btn-sm mb-0 me-3" target="_blank" href="#">Online
                                Builder</a>
                        </li>
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="<?php echo main_url('/admin1/assets/img/bruce-mars.jpg'); ?>" alt="profile_image"
                    ...
                    <div class="card">
                        <li class="list-group-item border-0 ps-0 pb-0">
                            ...
                            <a class="btn btn-facebook btn-simple mb-0 ps-1 pe-2 py-0 mt-3" href="#">
                                <img src="<?php echo main_url('/admin1/assets/img/shop-photo.jpg'); ?>"
                                    alt="profile_image" class="w-80 border-radius-lg shadow-sm mb-4">
                            </a>
                        </li>
                        <div class="ms-auto text-center">
                            <button type="button"
                                class="btn btn-outline-secondary text-dark px-3 btn-sm pt-2 mb-3 me-11">Edit</button>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="card card-blog card-plain">
                                        <div class="position-relative">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="<?php echo main_url('/admin1/assets/img/698472_R-1049.jpeg'); ?>"
                                        ...
                                        <div class="card-body px-1 pb-0">
                                            ...
                                            <div class="d-flex justify-content-between mb-3">
                                                ...
                                                <div class="ms-auto text-end">
                                                    <button type="button"
                                                        class="btn btn-outline-danger text-danger px-3 btn-sm pt-2 mb-0">Delete</button>
                                                    <button type="button"
                                                        class="btn btn-outline-secondary text-dark px-3 btn-sm pt-2 mb-0">Edit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                                    <div class="card card-blog card-plain">
                                        <div class="position-relative">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="<?php echo main_url('/admin1/assets/img/755236_COVER.jpg'); ?>"
                                ...
                                <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                                    <div class="card card-blog card-plain">
                                        <div class="position-relative">
                                            <a class="d-block shadow-xl border-radius-xl">
                                                <img src="<?php echo main_url('/admin1/assets/img/265844_COVER.jpeg'); ?>"
                                                    alt="img-blur-shadow" class="img-fluid shadow border-radius-xl">
                                            </a>
                                        </div>
                                        <div class="card-body px-1 pb-0">
