        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    ...
                    <div class="blog-head">
                            <h4 class="fs-3 text-capitalize fw-bold text-primary">the ultimate guide to opening a ready made garment shop in india</h4>
                        </div>
                        <div class="blog_img">
                            <img src="<?php echo CLS_SITE_URL; ?>img/blog_details5.webp" class="img-fluid w-100 rounded" alt="blog_details5">
                        </div>
