...
<body>
    ...
    <!-- Modal Search Start -->
    <div class="modal fade" id="searchModal" tab="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    ...
                    <div class="blog-head">
                            <h4 class="fs-3 text-capitalize fw-bold text-primary">wedding lehenga love: a brides journey to finding the one</h4>
                        </div>
                        <div class="blog_img">
                            <img src="<?php echo CLS_SITE_URL; ?>img/blog_details4.jpg" class="img-fluid w-100 rounded" alt="blog_details4">
                        </div>
